...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: People are not re added correctly after their turn is used.
    ...
    // Defect(s) Found: Adding a new player midway does not preserve the correct queue order.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: A person with 0 turns is not treated as having infinite turns.
    ...
    // Defect(s) Found: A person with negative turns is not treated as having infinite turns.
    ...
    // Defect(s) Found: The queue does not throw the correct exception when empty.
